...
public class Label extends JPanel {
	...
	public Label(String value, int max) {
	...
	public Label(Download download, Dimension dim, long size) {
		// TODO Auto-generated constructor stub
		super();
		...
		this.statisticsManager.addObserver(new Observer() {
			...
			public void update(boolean complete, long infos) {
				...
				if(!complete) {
					if(Label.this.statisticsManager.isSuspended()) {
						setValue("SUSPEND");
	...
	public Label(StatisticsManager statisticsmanager, String title, Dimension dim, long filesize) {
		// TODO Auto-generated constructor stub
		super();
		...
		this.statisticsManager.addObserver(new Observer() {
			...
			public void update(boolean complete, long infos) {
				...
				if(getTitle().contentEquals("Size: ")) {
					...
					if(complete||Label.this.statisticsManager.isSuspended())
						labelContainer.setVisible(false);
					else {
						labelContainer.setVisible(true);
