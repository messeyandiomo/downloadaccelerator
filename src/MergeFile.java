...
public class MergeFile extends Thread implements Observable {
	...
	public MergeFile(DownloadDirectories dir, FileProperties videoproperties, FileProperties audioproperties) {
		// TODO Auto-generated constructor stub
		super();
		this.setVideoFileName(dir.getDestinationDirectory() + videoproperties.getFilename());
		this.setAudioFileName(dir.getDestinationDirectory() + audioproperties.getFilename());
		this.setOutputFileName(dir.getDestinationDirectory() + videoproperties.getFilename() + ".merging." + videoproperties.getSubType());
	...
	public void updateObserver() {
		...
		for(Observer obs : this.listObserver)
			obs.update(iscompleted, datapercentage);
	}
